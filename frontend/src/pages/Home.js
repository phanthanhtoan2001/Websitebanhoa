            ...
            <div className="md:flex gap-4 py-2">
                <div className="md:w-1/2">
                    ...
                    <input
                        ...
                        className="border border-slate-600 bg-slate-100 w-96 p-2 rounded-md mr-2 focus:outline-none"
                        value={searchValue}
                        onChange={(e) => setSearchValue(e.target.value)}
                    />
                    <button
                        className="bg-green-500 text-white px-4 py-2 rounded-md hover:bg-blue-500"
                        style={{ fontSize: "18px" }}
                    >
                        Search
                    </button>
